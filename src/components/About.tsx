  ...
  const values = [
    {
      icon: Target,
      title: 'Missão',
      description: 'Transformar ideias em soluções tecnológicas que impulsionam o crescimento dos nossos clientes.'
    },
    {
      icon: Eye,
      title: 'Visão',
    ...
    },
    {
      icon: Heart,
      title: 'Valores',
      description: 'Transparência, qualidade, inovação e comprometimento com resultados excepcionais.'
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Somos especialistas em desenvolvimento de software sob demanda, com foco em pequenas e médias empresas que buscam crescer através da tecnologia.
          </p>
        </div>
