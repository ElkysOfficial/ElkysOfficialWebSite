// Conteudo da Politica de Cookies. Compartilhado entre a pagina publica
// /cookie-policy e a tela de aceite do portal do cliente.
const CookieBody = () => (
  <>
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>1.1.</strong> Cookies sao pequenos arquivos de texto armazenados no dispositivo do
          usuario quando este acessa um website. Esta Politica tambem abrange tecnologias similares
          de armazenamento local utilizadas pelo navegador (localStorage e sessionStorage), tratadas
          em conjunto pelo termo &quot;cookies e armazenamento similar&quot;.
        </p>
        <p>
          <strong>1.2.</strong> Os itens armazenados podem ser classificados quanto a origem
          (primeira parte ou terceiros), duracao (sessao ou persistente) e finalidade (necessarios,
          funcionais, analiticos ou de marketing).
        </p>
      </div>
    </section>
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>2.1.</strong> O website elkys.com.br e seus portais autenticados utilizam cookies
          e armazenamento similar para:
        </p>
        <ul className="list-none ml-6 space-y-1">
          ...
          <li>
            (d) Realizar analises estatisticas agregadas de acesso e desempenho do website publico,
        ...
        <p>
          ...
          <strong>
            nao utiliza cookies de marketing, remarketing, perfilamento publicitario ou pixels de
            redes sociais
          </strong>{" "}
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>3.1.</strong> No primeiro acesso, o usuario visualiza um banner de consentimento
          que permite <em>Aceitar</em> ou <em>Recusar</em> cookies nao estritamente necessarios.
        </p>
        <p>
          <strong>3.2.</strong> Os cookies estritamente necessarios (autenticacao e registro do
          proprio consentimento) dispensam autorizacao previa, conforme permitido pela LGPD para a
          base legal de execucao de contrato e legitimo interesse.
        </p>
        <p>
          <strong>3.3.</strong> Cookies analiticos do Google Analytics 4 sao carregados apenas apos
          o consentimento expresso e, mesmo assim, com tecnica de carga diferida (lazy-load) que so
          dispara mediante interacao do usuario com a pagina ou apos um intervalo de espera,
          reduzindo o impacto na privacidade e no desempenho.
        </p>
        <p>
          ...
          <code className="bg-muted px-1.5 py-0.5 rounded text-xs">elkys.com.br</code> ou contatando{" "}
    ...
    <section className="mb-10">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <div>
          ...
          <p className="mt-2">
            Indispensaveis para autenticacao no portal, registro de consentimento e funcionamento
            basico do website. Nao requerem consentimento previo.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">
            Memorizam preferencias do usuario, como tema visual. Podem ser desabilitados pelo
            navegador, mas a experiencia podera ser afetada.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">
            Coletam, de forma agregada e sem identificar individualmente o usuario, dados sobre
            paginas acessadas, dispositivo e duracao da visita. Sao carregados apenas apos
            consentimento.
          </p>
        </div>
      </div>
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>6.1.</strong> O usuario pode configurar seu navegador para recusar cookies, apagar
          cookies existentes ou ser notificado quando um cookie for enviado.
        </p>
        <p>
        ...
        <p className="mt-4">
          <strong>6.3.</strong> A desabilitacao de cookies estritamente necessarios impossibilitara
          o login nos portais. A desabilitacao dos demais nao impede a navegacao.
        </p>
      </div>
    </section>
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>7.1.</strong> O usuario pode optar por nao ser rastreado pelo Google Analytics em
          todos os sites instalando a extensao oficial:
        </p>
        <ul className="list-none ml-6 space-y-2">
          <li>
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>8.1.</strong> Esta Politica de Cookies esta em conformidade com a Lei Geral de
          Protecao de Dados (LGPD - Lei n. 13.709/2018) e o Marco Civil da Internet (Lei n.
          12.965/2014).
        </p>
        <p>
          <strong>8.2.</strong> Para detalhes sobre o tratamento de dados pessoais realizado pela
          Elkys, consulte a{" "}
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>9.1.</strong> Esta Politica podera ser atualizada para refletir mudancas no
          inventario de cookies ou na legislacao. Alteracoes relevantes serao comunicadas no website
          e o banner de consentimento sera reapresentado quando cabivel.
        </p>
      </div>
    </section>
    ...
    <section className="mb-10">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          <strong>10.1.</strong> Para duvidas sobre esta Politica de Cookies, entre em contato:
        </p>
