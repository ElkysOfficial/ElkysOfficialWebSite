  ...
  return (
    ...
    >
      ...
      {/* Padrão hexagonal rotacionando — fundo decorativo, nao e LCP.
          Oculto em mobile (<sm): no viewport pequeno a imagem escalada
          cobria grande parte da tela e o PageSpeed tratava a propria
          hexagonal (lazy + fetchpriority=low) como LCP, pedindo
          fetchpriority=high numa imagem que nao deveria ser critica.
