      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8 md:mb-12">
          {services.map((service, index) => (
            <Card
              key={index}
              className="relative overflow-hidden shadow-elegant hover:shadow-glow transition-all group flex flex-col h-full"
            >
              <CardHeader className="pb-3 sm:pb-4 md:pb-6">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-r ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0`}
                  >
