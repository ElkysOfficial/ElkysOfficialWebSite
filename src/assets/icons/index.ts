...
import HexagonSvg from "./svg/hexagon.svg?react";
...
import MoonSvg from "./svg/moon.svg?react";
...
import SunSvg from "./svg/sun.svg?react";
import TargetSvg from "./svg/target.svg?react";
import TrendingUpSvg from "./svg/trending-up.svg?react";
import UsersSvg from "./svg/users.svg?react";
import HeadphonesSvg from "./svg/headphones.svg?react";
import BlueprintSvg from "./svg/blueprint.svg?react";
import HandCoinsSvg from "./svg/hand-coins.svg?react";
import PiggyBankSvg from "./svg/piggy-bank.svg?react";
import ReceiptSvg from "./svg/receipt.svg?react";
...
import SuporteSvg from "./svg/suporte.svg?react";
import AgileSvg from "./svg/agile.svg?react";
import BarChartSvg from "./svg/bar-chart.svg?react";
import BanknoteSvg from "./svg/banknote.svg?react";
import CalendarXSvg from "./svg/calendar-x.svg?react";
import FolderSvg from "./svg/folder.svg?react";
import AgilMonoSvg from "./svg/agile-mono.svg?react";
import SuporteMonoSvg from "./svg/suporte-mono.svg?react";
import AgileFillSvg from "./svg/agile-fill.svg?react";
...
export const Hexagon = createIcon(HexagonSvg, "Hexagon");
...
export const Moon = createIcon(MoonSvg, "Moon");
export const Network = createIcon(NetworkSvg, "Network");
export const HandCoins = createIcon(HandCoinsSvg, "HandCoins");
export const Phone = createIcon(PhoneSvg, "Phone");
export const PiggyBank = createIcon(PiggyBankSvg, "PiggyBank");
...
export const Sun = createIcon(SunSvg, "Sun");
export const Target = createIcon(TargetSvg, "Target");
export const TrendingUp = createIcon(TrendingUpSvg, "TrendingUp");
export const Users = createIcon(UsersSvg, "Users");
export const Headphones = createIcon(HeadphonesSvg, "Headphones");
export const Receipt = createIcon(ReceiptSvg, "Receipt");
export const Wallet = createIcon(WalletSvg, "Wallet");
export const Wrench = createIcon(WrenchSvg, "Wrench");
export const X = createIcon(XSvg, "X");
export const Zap = createIcon(ZapSvg, "Zap");
export const Suporte = createIcon(SuporteSvg, "Suporte");
export const Agile = createIcon(AgileSvg, "Agile");
export const BarChart = createIcon(BarChartSvg, "BarChart");
export const Banknote = createIcon(BanknoteSvg, "Banknote");
export const CalendarX = createIcon(CalendarXSvg, "CalendarX");
export const Folder = createIcon(FolderSvg, "Folder");
export const AgileMono = createIcon(AgilMonoSvg, "AgileMono");
export const SuporteMono = createIcon(SuporteMonoSvg, "SuporteMono");
export const AgileFill = createIcon(AgileFillSvg, "AgileFill");
export const SuporteFill = createIcon(SuporteFillSvg, "SuporteFill");
