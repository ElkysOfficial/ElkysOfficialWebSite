    ...
    <div className="space-y-8">
      ...
      {nextCharge &&
        (() => {
          ...
          const daysToDue = Math.round((due.getTime() - today.getTime()) / (1000 * 60 * 60 * 24));
          ...
          return (
            <div className={`rounded-xl border px-4 py-3 sm:px-5 sm:py-4 ${toneClasses}`}>
            ...
            {visibleProjects.map((project) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p
                      className="truncate text-[15px] font-semibold leading-snug text-foreground transition-colors group-hover:text-primary"
                      title={project.name}
                    >
                      {project.name}
                    </p>
                    <p
                      ...
                      title={`Etapa atual: ${project.current_stage}`}
                    >
