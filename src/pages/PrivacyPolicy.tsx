        ...
        >
          ...
          <article className="max-w-none">
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  aos usuarios do website elkys.com.br sobre o tratamento de dados pessoais
                  realizado pela Elkys.
                </p>
                <p>
                  <strong>1.2.</strong> Esta Politica esta em conformidade com a Lei Geral de
                  Protecao de Dados Pessoais (LGPD - Lei n. 13.709/2018) e demais normas aplicaveis
                  a protecao de dados no Brasil.
                </p>
                <p>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>2.1.</strong> Para fins desta Politica, o controlador dos dados pessoais
                  e:
                </p>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <ul className="list-none ml-6 space-y-1">
                  ...
                  <li>
                    (e) Informacoes contidas em mensagens enviadas pelo formulario de contato.
                  </li>
                </ul>
                <p className="mt-4">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>4.1.</strong> Os dados pessoais sao tratados para as seguintes
                  finalidades:
                </p>
                <ul className="list-none ml-6 space-y-1">
                  <li>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>5.1.</strong> O tratamento de dados pessoais e realizado com fundamento
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p className="mt-4">
                  <strong>7.2.</strong> Apesar das medidas de seguranca implementadas, nenhum
                  sistema e completamente imune a riscos.
                </p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>8.1.</strong> Os dados pessoais serao mantidos pelo periodo necessario
                  para:
                </p>
                <ul className="list-none ml-6 space-y-1">
                  ...
                  <li>
                    (c) Exercer direitos em processos judiciais, administrativos ou arbitrais.
                  </li>
                </ul>
                <p className="mt-4">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  refletir alteracoes nas praticas de tratamento de dados ou na legislacao
                  aplicavel.
                </p>
                <p>
            ...
            <div className="border-t border-border pt-8 mt-12">
              <p className="text-sm text-muted-foreground text-center">
                Ao utilizar este website, o usuario declara estar ciente das praticas de tratamento
                de dados descritas nesta Politica de Privacidade.
              </p>
            </div>
          </article>
        </main>
