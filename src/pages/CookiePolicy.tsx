          ...
          <article className="prose prose-lg max-w-none">
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  dispositivo do usuario quando este acessa um website. Sao utilizados para otimizar
                  a navegacao e fornecer informacoes ao administrador do site.
                </p>
                <p>
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <div>
                  ...
                  <div className="bg-muted/30 p-4 rounded-lg mt-3">
                    <p className="text-sm">
                      <strong>Exemplos:</strong> Cookies de autenticacao, seguranca e preferencias
                      de sessao.
                    </p>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  <strong>4.2.</strong> Cookies de terceiros sao definidos por dominios externos,
                  como servicos de analise (Google Analytics) ou plataformas de publicidade.
                </p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>6.1.</strong> O usuario pode configurar seu navegador para recusar todos
                  ou alguns cookies, ou para ser notificado quando um cookie e enviado.
                </p>
                <p>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>7.1.</strong> O usuario pode optar por nao participar de cookies
                  especificos de terceiros:
                </p>
                <ul className="list-none ml-6 space-y-2">
                  <li>
