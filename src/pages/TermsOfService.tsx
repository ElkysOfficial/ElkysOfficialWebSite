          ...
          <article className="max-w-none">
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  <strong>1.1.</strong> O presente instrumento estabelece os Termos de Uso
                  aplicaveis ao acesso e utilizacao do website elkys.com.br, de titularidade da
                  Elkys, pessoa juridica inscrita sob o regime de Microempreendedor Individual
                  (MEI).
                </p>
                <p>
                ...
                <p>
                  ...
                  qualquer tempo, os presentes Termos, mediante publicacao da versao atualizada
                  neste website.
                </p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  qualquer conteudo sem autorizacao previa e expressa constitui violacao dos
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  comercial ou contrato especifico, que estabelecera escopo, prazos, valores e
                  demais condicoes aplicaveis.
                </p>
                <p>
                  <strong>6.2.</strong> Os precos dos servicos serao definidos caso a caso, de
                  acordo com a complexidade e requisitos de cada projeto.
                </p>
                <p>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  garantias de qualquer natureza quanto a disponibilidade ininterrupta ou ausencia
                  de erros.
                </p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  <strong>9.3.</strong> Estes Termos sao regidos pelas leis da Republica Federativa
                  do Brasil.
                </p>
                <p>
            ...
            <div className="border-t border-border pt-8 mt-12">
              <p className="text-sm text-muted-foreground text-center">
                Ao utilizar este website, o usuario declara estar ciente e de acordo com os
